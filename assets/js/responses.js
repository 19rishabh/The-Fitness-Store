function getBotResponse(input) {
    ...
    if (input == "hello") {
        ...
        return "Here's our contact information: <br /><br /> <strong>Email:</strong> TheFitnessStore@gmail.com <br /> <strong>Phone Number:</strong> 9769319089 <br /> <strong>Messenger:</strong> @TheFitnessStore  <br /> <strong>Address:</strong> KJSCE, Vidyavihar ";
